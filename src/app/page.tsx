    ...
    if (!blogs) {
      const dummyBlogs = [
        ...
        },
        {
          ...
          description:
            "Tailwind CSS is a utility-first CSS framework packed with classes like flex, pt-4, text-center...",
        ...
        },
        {
          ...
          description:
            "Learn about different client-side storage options like localStorage, sessionStorage, and IndexedDB...",
        ...
        },
        {
          ...
          description:
            "Authentication is a critical part of most web applications. In this post, we explore...",
